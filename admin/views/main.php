  ...
  <header class="site-header">
      <div class="container-fluid">
          <a href="#" class="site-logo">
              <img class="hidden-md-down" src="<?php echo ROOT_URL; ?>assets/img/logoadmin.png" alt="logo admin">
              <img class="hidden-lg-down" src="<?php echo ROOT_URL; ?>assets/img/logomob.png" alt="logo admin">
          </a>
